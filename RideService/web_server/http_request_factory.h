...
#include "handlers/ride_handler.h"
...
public:
        ...
        const HTTPServerRequest& request)
    {
        ...
        if (hasSubstr(request.getURI(),"/add_category") ||
            hasSubstr(request.getURI(),"/add_ride") ||
            hasSubstr(request.getURI(),"/add_route_to_ride") ||
            hasSubstr(request.getURI(),"/read_all_routes_from_ride")) 
